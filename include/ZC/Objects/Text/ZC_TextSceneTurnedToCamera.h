...
class ZC_TextSceneTurnedToCamera : public ZC_TextData, public ZC_TurnToCamera
{
public:
    /*
    Params:
    ...
    */
    ZC_TextSceneTurnedToCamera(ZC_FontNameHeight fontData, const std::string& _text, ZC_TextAlignment _alignment,
