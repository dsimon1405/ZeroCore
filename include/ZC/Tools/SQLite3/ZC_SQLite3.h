...
//             case SQLITE_ROW:
//             {
//                 ZC_Tuple<TParams...>& newTuple = response.emplace_back(ZC_Tuple<TParams...>());
//                 auto columns = sqlite3_column_count(stmt);
//                 for (int i = 0; i < columns; ++i)
//                 {
//                     switch (sqlite3_column_type(stmt, i))
//                     {
//                     case SQLITE_INTEGER: newTuple.Set(i, sqlite3_column_int(stmt, i)); break;
//                     case SQLITE_FLOAT: newTuple.Set(i, sqlite3_column_double(stmt, i)); break;
//                     case SQLITE_TEXT: newTuple.Set(i, sqlite3_column_text16(stmt, i)); break;
//                     case SQLITE_BLOB: newTuple.Set(i, sqlite3_column_text(stmt, i)); break;
...
//                                                                                                      USAGE
    // ZC_SQLite3::Open("/home/dmitry/projects/ZCreator/zcr.db", SQLITE_OPEN_READONLY);

    // std::list<ZC_Tuple<int, int, int, int, int>> l;
    // bool ok = ZC_SQLite3::Exec("SELECT vaoFormat.vaoFormatID, vaoFormat.Location, vaoFormat.Size, glType.define, vaoFormat.Normalize"
    //     " FROM vaoFormat"
    //     " INNER JOIN glType ON VAOFormat.glTypeID = glType.glTypeID;"
    //     , l);