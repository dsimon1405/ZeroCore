    ...
    bmt_float(bnt_red_uchar.VGetWidthComposite_Obj() / 2.f, false)
{
    ...
    bmt_uchar.SetButtonColor_BS(bmt_uchar.colorsButton.color_button_pressed);
...
void ZC_GUI_ColorManipulator::MakeActiveButtonType(bool makeActiveUChar)
{
    ...
    if (IsActiveUCharButtons())
    {
        ...
        bmt_uchar.SetButtonColor_BS(bmt_uchar.colorsButton.color_button);   //  move active color
        bmt_float.SetButtonColor_BS(bmt_float.colorsButton.color_button_pressed);   //  set active color
    }
    else
    {
        bnt_red_float.VSetDrawState_Obj(false, false);
        ...
        bmt_float.SetButtonColor_BS(bmt_float.colorsButton.color_button);   //  move active color
        bmt_uchar.SetButtonColor_BS(bmt_uchar.colorsButton.color_button_pressed);   //  set active color
    }
