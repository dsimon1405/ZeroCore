...
ZC_GUI_Switch<ZC_GUI_ButtonMouseText>::Variant::Variant(const std::wstring& name, float width, float height, const ZC_Vec2<float>& bl, const ZC_GUI_ColorsButton& _colorsButton, uint _color_text)
    ...
    ZC_GUI_ButtonMouseText(width, height, ZC_GUI_BF__None, ZC_GUI_TextForButton(ZC_GUI_TextForButton::Indent(0, ZC_GUI_TextForButton::Indent::Center), name, true, 0, ZC_GUI_TextAlignment::Left, _color_text), _colorsButton)
{
    this->VSet_pBL_Obj(bl);
}
...
template <>     //  ZC_GUI_ButtonMouse specialization
ZC_GUI_Switch<ZC_GUI_ButtonMouse>::ZC_GUI_Switch(const std::vector<ZC_GUI_UV>& uvs, float width, float height, bool orientation_horizontal, float distance, const ZC_GUI_ColorsButton& _colorsButton)
...
template <>     //  ZC_GUI_ButtonMouseAndKeyboard specialization
ZC_GUI_Switch<ZC_GUI_ButtonMouseAndKeyboard>::ZC_GUI_Switch(const std::vector<ZC_GUI_KeyboardUV>& keyboardUVs, float width, float height, bool orientation_horizontal, float distance, const ZC_GUI_ColorsButton& _colorsButton)
...
template <>     //  ZC_GUI_ButtonMouseText specialization
ZC_GUI_Switch<ZC_GUI_ButtonMouseText>::ZC_GUI_Switch(const std::vector<std::wstring>& names, float width, float height, bool orientation_horizontal, float distance, const ZC_GUI_ColorsButton& _colorsButton, uint _color_text)
    ...
    ZC_GUI_ButtonMouseText(this->VGetWidth_Obj(), height, ZC_GUI_BF__None, ZC_GUI_TextForButton(ZC_GUI_TextForButton::Indent(0, ZC_GUI_TextForButton::Indent::Center), names[0], true, 0, ZC_GUI_TextAlignment::Left, _color_text), _colorsButton)
{
