...
ZC_GUI_ButtonMouseText::ZC_GUI_ButtonMouseText(float width, float height, ZC_GUI_ButtonFlags _buttonFlags, ZC_GUI_TextForButton&& _textForButton,
...
{
    return textForButton.indent.indentFlag_X == ZC_GUI_TFB_Indent::OutOfButtonRight || textForButton.indent.indentFlag_X == ZC_GUI_TFB_Indent::OutOfButtonLeft ?
        this->VGetWidth_Obj() + this->textForButton.VGetWidthComposite_Obj() : this->VGetWidth_Obj();
}
