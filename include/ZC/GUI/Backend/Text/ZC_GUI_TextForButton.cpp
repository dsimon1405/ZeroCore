...
ZC_GUI_TextForButton::ZC_GUI_TextForButton(const ZC_GUI_TFB_Indent& _indent, const std::wstring& wstr, bool _isImmutable, int reserveWidth, ZC_GUI_TextAlignment textAlignment, unsigned int color)
...
void ZC_GUI_TextForButton::VSet_pBL_Obj(const ZC_Vec2<float>& _bl)
{
    ...
    case ZC_GUI_TFB_Indent::OutOfButton:
    {
