...
struct ZC_GUI_TFB_Indent
{
    enum Location
    {
        ...
        OutOfButtonLeft     //  out of button from left side
    };
...
struct ZC_GUI_TextForButton : public ZC_GUI_Text
{
    ...
    - color - text's color.
    */
    ZC_GUI_TextForButton(const ZC_GUI_TFB_Indent& _indent, const ZC_GUI_Font* pFont, const std::wstring& wstr, bool _isImmutable, int reserveWidth, ZC_GUI_TextAlignment textAlignment,
