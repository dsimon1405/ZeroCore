...
{
    bool isActive = true;  //  active event manager or not
    ...
    ZC_GUI_Window* pWin_mouseButtonDown_watcher = nullptr;     //  object wich need to know about down left/right mouse buttons
    ...
    void SetMouseButtonDownWatcherObj(ZC_GUI_Window* _pObj_mouseButtonDown_watcher);
