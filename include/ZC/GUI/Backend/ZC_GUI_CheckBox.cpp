...
ZC_GUI_CheckBox::ZC_GUI_CheckBox(ZC_GUI_TFB_Indent_Location name_pos, const ZC_GUI_Font* pFont, const std::wstring& name, bool _isOn, ZC_Function<void(bool)>&& _callback_state_changed,
