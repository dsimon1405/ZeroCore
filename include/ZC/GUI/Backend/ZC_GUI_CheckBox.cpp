...
ZC_GUI_CheckBox::ZC_GUI_CheckBox(const std::wstring& name, bool _isOn, ZC_Function<void(bool)> _callback, const ColorsCheckBox& colorsCheckBox)
    ...
    ZC_GUI_ButtonMouseText(0, 0, ZC_GUI_BF__None, ZC_GUI_TextForButton(ZC_GUI_TFB_Indent(ZC_GUI_TextManager::GetFontHeight() * 0.5f, ZC_GUI_TFB_Indent::OutOfButtonRight),
