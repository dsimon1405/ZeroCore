...
struct ZC_GUI__ClickKeyboard : public ZC_GUI__Click<ZC_GUI__ButtonKeyboard>
{
    ...
    */
    ...
    - _colorsButton - button colors (may stay default).
    */
    ZC_GUI__ClickKeyboard(ZC_ButtonID _buttonId, float width, float height, const ZC_GUI_UV& uv, ZC_Function<void(float)>&& _callback_button_down, ZC_Function<void(float)>&& _callback_button_up,
        const ZC_GUI_ColorsButton& _colorsButton = {});
};
