...
ZC_GUI_ColorsButtonText::ZC_GUI_ColorsButtonText(uint _text_color, ZC_GUI_ColorsButton _colorsButton)
...
ZC_GUI__ButtonMouseText::ZC_GUI__ButtonMouseText(float width, float height, ZC_GUI_ButtonFlags _buttonFlags, ZC_GUI_TextForButton&& text, const ZC_GUI_UV& uv,
        const ZC_GUI_ColorsButton& _colorsButton)
    :ZC_GUI__Button<ZC_GUI__BM<ZC_GUI_ButtonMouseText>>(ZC_GUI__BM<ZC_GUI_ButtonMouseText>(this, ZC_GUI_ButtonMouseText(width, height, _buttonFlags, std::move(text),
        uv, _colorsButton)))
{}
