...
ZC_GUI__CheckBox::ZC_GUI__CheckBox(ZC_GUI_TFB_Indent_Location indent_lok, const ZC_GUI_Font* pFont, const std::wstring& name, bool _isOn, ZC_Function<void(bool)>&& _callback_state_changed,
    ...
    : ZC_GUI__Obj<ZC_GUI_CheckBox>(ZC_GUI_CheckBox(indent_lok, pFont, name, _isOn, std::move(_callback_state_changed), std::move(_callback_focuse_changed),
