...
ZC_uptr<ZC_Drawer> ZC_Drawer::GetRendererLevelDrawer(ZC_DrawerLevel lvl)
{
    switch (lvl)
    {
    case ZC_DrawerLevels::Drawing: return { new ZC_DrawerFL<const ZC_ShProg*, const ZC_VAO*, ZC_TexturesHolder, ZC_RLDData_Uniforms_GLDraw>(0, true, false, {}) };
    ...
    case ZC_DrawerLevels::TextWindowIntoScene: return { new ZC_DrawerFL<const ZC_ShProg*, ZC_TexturesHolder, const ZC_VAO*, ZC_RLDData_Uniforms_GLDraw>
        (GL_DEPTH_BUFFER_BIT, true, false, ZC_GLBlend(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA)) };
    case ZC_DrawerLevels::OrthoBlend: return
        { new ZC_DrawerFL<const ZC_ShProg*, ZC_TexturesHolder, const ZC_VAO*, ZC_RLDData_Uniforms_GLDraw>(0, false, false, ZC_GLBlend(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA)) };
    default:
    {
