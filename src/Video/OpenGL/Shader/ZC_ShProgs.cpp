...
typename ZC_ShProgs::ShNames ZC_ShProgs::GetShNames(ZC_ShPName name) const noexcept    //  add here new
{
    ...
    switch (name)
    {
    case ShPN_ZC_GUI: return { VName::gui, {}, FName::gui, GName::gui }; 
    ...
    case ShPN_Game_Sphere: return ShNames{ .vName = VName::game_sphere, .vaoConfigData = VAOConfigData{ .formatShVLayout = ZC_VAOL__F_3_0__I_2_10_10_10_REV_1_1_N__F_2_2,
    ...
    case ShPN_Game_Flame: return ShNames{ .vName = VName::game_particle_system, .vaoConfigData = {}, .fName = FName::game_particle_system, .gName = GName::game_particle_system };
    // case ShPN_Game_Flame: return ShNames{ .vName = VName::game_particle_system, .vaoConfigData = VAOConfigData{ .formatShVLayout = ZC_VAOL__F_4_0, .usingFormatsPacker = VAOPack(0) },
    //     .fName = FName::game_particle_system, .gName = GName::game_particle_system };
    case ShPN_Game_CubeMap: return ShNames{ .vName = VName::game_cube_map, .vaoConfigData = VAOConfigData{ .formatShVLayout = ZC_VAOL__F_3_0, .usingFormatsPacker = VAOPack(0) },
        .fName = FName::game_cube_map, .gName = GName::none };
    case ShPN_Game_CylinderDMG: return ShNames{ .vName = VName::game_cylinder_dmg, .vaoConfigData = VAOConfigData{ .formatShVLayout = ZC_VAOL__F_3_0__I_2_10_10_10_REV_1_1_N__F_2_2, .usingFormatsPacker = VAOPack(0).Pack(1).Pack(2) },
        .fName = FName::game_cylinder_dmg, .gName = GName::none };
