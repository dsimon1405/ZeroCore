...
ZC_DA<typename ZC_VAOConfig::Format> ZC_VAOConfig::GetFormats(ZC_VAOLayout spf)
{
    ...
    case ZC_VAOL__F_3_0__UB_4_1_N: return { new Format[]{ { 0, 4, GL_FLOAT, GL_FALSE }, { 1, 4, GL_UNSIGNED_BYTE, GL_TRUE } }, 2 };
    case ZC_VAOL__F_3_0__UB_3_1_N__I_2_10_10_10_REV_1_2_N: return { new Format[]{ { 0, 3, GL_FLOAT, GL_FALSE }, { 1, 3, GL_UNSIGNED_BYTE, GL_TRUE },
        { 2, 4, GL_INT_2_10_10_10_REV, GL_TRUE } }, 3 };
